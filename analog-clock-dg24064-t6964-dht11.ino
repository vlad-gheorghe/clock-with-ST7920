...
#include <DHT.h>
#define DHTPIN 19     // what pin we're connected DHT11
...
void draw(void) {
 ...
 u8g.drawCircle(ScreenWithC-deics-1,ScreenHeightC,31);
//  u8g.drawCircle(10,ScreenHeightC,52);
 ...
 // u8g.setFont(u8g_font_5x7);
  //u8g.setFont(u8g_font_osb21); 
   ...
   //TegnViser(Timer-1 + Minutt/60, 12.0, 15);
 ...
 u8g.setPrintPos(145, 12); u8g.setFont(u8g_font_9x18B);
...
//u8g.setPrintPos(56,60);u8g.print("T:");
//sensors.requestTemperatures(); temperature = sensors.getTempCByIndex(0); 
float temperature = dht.readTemperature(); int h = dht.readHumidity();
 float temperatureC = temperature-2;
  String thisTemp1 = String(temperatureC) + " C";
  u8g.drawCircle(215, 54, 2);
   // printing output as follows used less program storage space
  const char* thisTemp = (const char*) thisTemp1.c_str();
   //u8g.setFont(u8g_font_7x13B); 
   u8g.drawStr(165,62,thisTemp);
   
  //u8g.setFont(u8g_font_6x12); u8g.drawStr(65,60,"Mesaj de test");
  
 h = dht.readHumidity();
 float humC = h;
  String thisHum1 = String(humC) + " %";
 // u8g.drawCircle(224, 52, 2);
   // printing output as follows used less program storage space
  const char* thisHum = (const char*) thisHum1.c_str();
   //u8g.setFont(u8g_font_7x13B); 
   u8g.drawStr(85,62,thisHum);
   
u8g.setPrintPos(65, 12);
//u8g.setFont(u8g_font_6x10);
...
void TegnKlokkeBg() { // draw clock background
    ...
    u8g.setFontPosTop();
    u8g.drawStr(62-deics, 4, "12");
    u8g.drawStr(89-deics, 25, "3");
    u8g.drawStr(67-deics, 45, "6");
    u8g.drawStr(44-deics, 25, "9");
